    ...
    <div className="space-y-10 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-gray-400 mt-1">บันทึกประวัติการทำงานและการเปลี่ยนแปลงที่สำคัญภายในระบบ</p>
        </div>
      </div>
      ...
      <Card className="p-6 border-white/5 bg-white/2 backdrop-blur-md shadow-xl relative overflow-hidden">
        ...
        <form onSubmit={handleSearch} className="relative group">
          ...
          <Input
            placeholder="ค้นหาตาม Entity, Action หรือ ID..."
            value={searchQuery}
      ...
      <Card className="border-white/5 bg-white/2 backdrop-blur-md shadow-2xl relative overflow-hidden">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-white/5 text-gray-400 text-[10px] uppercase tracking-widest font-black">
                  <th className="px-6 py-5 text-left border-b border-white/5">Administrator</th>
                  <th className="px-6 py-5 text-left border-b border-white/5">Action</th>
                  <th className="px-6 py-5 text-left border-b border-white/5">Entity Info</th>
                  <th className="px-6 py-5 text-left border-b border-white/5">Timestamp</th>
                  <th className="px-6 py-5 text-right border-b border-white/5">Details</th>
                </tr>
              </thead>
                  ...
                  >
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-bold text-white text-sm">{log.user?.username || "System"}</p>
                    ...
                    <td className="px-6 py-6 text-right">
                      <Button
                        ...
                        className="w-10 h-10 rounded-xl hover:bg-white/5 transition-all text-gray-500 hover:text-white"
                      >
        ...
        {!loading && logs.length === 0 && (
          <div className="p-20 text-center relative overflow-hidden">
            ...
            <p className="text-gray-500 font-black uppercase tracking-widest relative z-10">No audit logs found</p>
          </div>
        )}
      </Card>
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-black text-white uppercase tracking-tight">Log Details</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                    <p className="text-[10px] text-gray-600 uppercase font-black mb-2">Old Data</p>
                  ...
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                    <p className="text-[10px] text-gray-600 uppercase font-black mb-2">New Data</p>
                    <pre className="text-xs text-gray-400 overflow-auto max-h-64 scrollbar-hide font-mono">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                    <p className="text-[10px] text-gray-600 uppercase font-black mb-1">IP Address</p>
                    <p className="text-sm font-bold text-white font-mono">{selectedLog.ipAddress || "Internal"}</p>
                  </div>
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                    <p className="text-[10px] text-gray-600 uppercase font-black mb-1">User Agent</p>
